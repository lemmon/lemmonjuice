...
<body class="col justify-between sd-p1 max50">
  ...
  <main>
    ...
    <section>
      ...
      <header class="p05 sd-py1 row items-center">
        <div class="p05 span1 div color-black-10"></div>
        <h1 class="p05 sd-py1 fw600 lh4 color-black-50">Projects</h1>
        <div class="p05 span8 div color-black-10"></div>
      </header>

      <div class="p1">
        <article class="p1">
          <h2 class="fw600 lh4"><a class="ul" href="http://abrusco.com/">Abrusco</a></h2>
          <p class="lh4 color-black-80">Hackable CSS toolbox.</p>
        </article>
        <article class="p1">
          <h2 class="fw600 lh4"><a class="ul" href="https://github.com/lemmon/babel-env-cli">Babel Env CLI</a></h2>
          <div class="lh4">
            <p class="color-black-80">CLI interface for Babel + @babel/preset-env. Global installation.</p>
    ...
    <section>
      ...
      <header class="p05 sd-py1 row items-center">
        <div class="p05 span1 div color-black-10"></div>
        <h1 class="p05 sd-py1 fw600 lh4 color-black-50">Experiments</h1>
        <div class="p05 span8 div color-black-10"></div>
      </header>
    ...
    <section>
      ...
      <header class="p05 sd-py1 row items-center">
        <div class="p05 span1 div color-black-10"></div>
        <h1 class="p05 sd-py1 fw600 lh4 color-black-50">References</h1>
        <div class="p05 span8 div color-black-10"></div>
      </header>
      ...
      <div class="p1">
        <div class="md-grid md-grid2">
          ...
          <article class="p1">
            ...
            <div class="lh4">
              <p class="color-black-80">January 2017&ndash;present, freelance</p>
              <p class="color-black-40">html, css, javascript, php</p>
            </div>
          </article>
          <article class="p1">
            ...
            <div class="lh4">
              <p class="color-black-80">March 2014&ndash;present, freelance</p>
              <p class="color-black-40">html, css, javascript, php</p>
            </div>
          </article>
          <article class="p1">
    ...
    <section>
      ...
      <header class="p05 sd-py1 row items-center">
        <div class="p05 span1 div color-black-10"></div>
        <h1 class="p05 sd-py1 fw600 lh4 color-black-50">Skills</h1>
        <div class="p05 span8 div color-black-10"></div>
      </header>
  ...
  <footer class="pb1">
    ...
    <header class="p05 sd-py1 row items-center">
      <div class="p05 span1 div color-black-10"></div>
      <h1 class="p05 sd-py1 fw600 lh4 color-black-50">/</h1>
      <div class="p05 span8 div color-black-10"></div>
    </header>

    <nav class="p1">
      <ul class="py05 row flex-wrap">
        <li class="px1 py05"><script>
        var u = '%6a%70%65%6c%61%6b';
        var d = '%67%6d%61%69%6c';
        var t = '%63%6f%6d';
        document.write('<a class="ul" href=' + 'mail' + 'to:' + u + '%40' + d + '%2e' + t
          + '>' + 'Email' + '</a>');
        </script></li>
